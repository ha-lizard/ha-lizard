...
# Subsequent run will inheret real
...
then
	...
	then
		...
		then
			...
			## tiem to takeover in case this was
...
# on slave after $XAPI_COUNT attemps
#################################################
if [[ $STATE == slave* ]]
then
						...
						then
							...
							case $RETVAL in
								...
								1)
									...
									# running will be inthe off state after reboot. VMs will stay off unless
